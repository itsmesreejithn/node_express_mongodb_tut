...
var stripe = Stripe("pk_test_51OerncSBSUncXohLr1mnWktKy5EuuQ47ycJDTNsWM6Nd4spoE3sFwHVkZ4qM9WKKCoySs9rfJ2Z39R3twNaNTlrT009GcX3Y6W");
...
if (userDataForm) userDataForm.addEventListener("submit", function (e) {
  ...
  form.append("email", document.getElementById("email").valu);
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "33657" + '/');
